  ...
  return <section className="py-20 bg-gradient-to-br from-background via-background to-muted/20 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {kitsDealsProducts.map((product, index) => (
              <CarouselItem key={product.id} className="pl-2 md:pl-4 basis-1/2 sm:basis-1/2 lg:basis-1/3">
                ...
                >
                  ...
                  <div className="relative bg-card/40 backdrop-blur-xl border border-border/20 rounded-3xl p-1 shadow-lg group-hover:shadow-2xl group-hover:border-primary/30 group-hover:scale-105" style={{ transition: `all 400ms cubic-bezier(0.34, 1.56, 0.64, 1)`, willChange: 'transform, box-shadow, border-color' }}>
                    {/* Gradient Border Effect */}
                    <div className="absolute inset-0 bg-gradient-to-r from-primary/20 via-accent/20 to-secondary/20 rounded-3xl opacity-0 group-hover:opacity-100 blur-sm" style={{ transition: `opacity 400ms cubic-bezier(0.4, 0, 0.2, 1)` }} />
        ...
        <div className="text-center mt-16">
          <Button
            size="lg"
            onClick={() => navigate('/shop?section=kits-deals')}
