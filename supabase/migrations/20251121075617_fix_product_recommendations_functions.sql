/*
  # Fix Product Recommendations Functions

  1. Changes
    - Update get_related_products to remove keywords column reference
    - Update get_cart_suggestions to work with existing schema
    - Use only tags column for matching (keywords doesn't exist)

  2. Notes
    - Products table has tags column but not keywords
    - Functions now work with actual schema
*/

-- Drop and recreate get_related_products function with correct schema
...
-- Drop and recreate get_cart_suggestions function with correct schema
